...
func (o *OrderMaker) MkPricedOrder(price int64, kind MsgKind) *Order {
	od := &Order{}
	o.writePricedOrder(price, kind, od)
	return od
}

func (o *OrderMaker) writePricedOrder(price int64, kind MsgKind, od *Order) {
...
func (o *OrderMaker) MkOrders(prices []int64, kind MsgKind) []Order {
...
func (o *OrderMaker) RndTradeSet(size, depth int, low, high int64) ([]Order, error) {
	if depth > size {
